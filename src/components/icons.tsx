...
export const IconTarget: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className ?? iconClass} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-14c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm0-6c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
  </svg>
);

export const IconGears: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className ?? iconClass} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
...
export const IconDatabase: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className ?? iconClass} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
    <path d="M12 3C7.58 3 4 4.79 4 7s3.58 4 8 4 8-1.79 8-4-3.58-4-8-4zm0 8c-4.42 0-8-1.79-8-4s3.58-4 8-4 8 1.79 8 4-3.58 4-8 4zm0 8c-4.42 0-8-1.79-8-4s3.58-4 8-4 8 1.79 8 4-3.58 4-8 4z" />
  </svg>
);
...
export const IconWarning: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className ?? iconClass} viewBox="0 0 24 24" fill="currentColor" aria-hidden>
