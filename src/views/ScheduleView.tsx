...
/**
 * Schedule tab content: date picker, filters, and events/classes/entries list.
 * Uses design tokens from design-system.json.
 */
export function ScheduleView(): React.ReactElement {
  ...
  useEffect(() => {
    if (data?.show_name) setHeaderLabel(data.show_name);
    return () => setHeaderLabel(null);
  }, [data?.show_name, setHeaderLabel]);
